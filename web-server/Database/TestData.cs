...
PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
            new TutorDTO()
{FirstName = "Карина", MiddleName="Романовна", LastName = "Уварова", About = " Преподаю английский язык 5 лет. Выпустила более 100 учеников с баллом ЕГЭ > 85 и 75 учеников с баллом ОГЭ > 90", BirthDate = DateTime.Parse("05.12.1997"), UserDates = new List<UserDate>(){ }, Email = "karina_uvarova@mail.ru", Phone = "+79547803756", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
            new TutorDTO(){FirstName = "Александр", MiddleName="Дмитриевич", LastName = "Михайлов", About = " Преподаю английский язык 5 лет. Выпустил более 100 учеников с баллом ЕГЭ > 85 и 75 учеников с баллом ОГЭ > 90", BirthDate = DateTime.Parse("08.11.1999"), UserDates = new List<UserDate>(){ }, Email = "alexander_mihailov@mail.ru", Phone = "+79527803756", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
            new TutorDTO(){FirstName = "Елизавета", MiddleName="Олеговна", LastName = "Клюка", About = " Преподаю английский язык 6 лет. Выпустила более 100 учеников с баллом ЕГЭ > 85 и 75 учеников с баллом ОГЭ > 90", BirthDate = DateTime.Parse("10.09.2001"), UserDates = new List<UserDate>(){ }, Email = "elizabeth_kluka@mail.ru", Phone = "+79023801178", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
          new TutorDTO(){FirstName = "Егор", MiddleName="Данилович", LastName = "Абрамов", About = " Преподаю английский язык 6 лет. Выпустил более 100 учеников с баллом ЕГЭ > 85 и 75 учеников с баллом ОГЭ > 90", BirthDate = DateTime.Parse("10.02.1999"), UserDates = new List<UserDate>(){ }, Email = "egor_abramov@mail.ru", Phone = "+79116790554", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
            new TutorDTO()
 {FirstName = "Маргарита", MiddleName="Павловна", LastName = "Волкова", About = " Преподаю английский язык 20 лет. Выпустила более 200 учеников с баллом ЕГЭ > 90 и 150 учеников с баллом ОГЭ > 90", BirthDate = DateTime.Parse("10.11.1980"), UserDates = new List<UserDate>(){ }, Email = "margo_volkova@mail.ru", Phone = "+79158476586", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
            new TutorDTO(){FirstName = "Светлана", MiddleName="Николаевна", LastName = "Примакова", About = " Преподаю английский язык 20 лет. Готовлю учеников к сдаче международных экзаменов на высокий балл!", BirthDate = DateTime.Parse("10.11.1980"), UserDates = new List<UserDate>(){ }, Email = "svetlana_primakova@mail.ru", Phone = "+79108476758", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
         new TutorDTO(){FirstName = "Ольга", MiddleName="Алексеевна", LastName = "Жукова", About = " Преподаю английский язык 8 лет.", BirthDate = DateTime.Parse("10.11.1998"), UserDates = new List<UserDate>(){ }, Email = "olga_zhukova@mail.ru", Phone = "+79065456789", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
        new TutorDTO(){FirstName = "Роман", MiddleName="Алексеевич", LastName = "Карпов", About = " Преподаю английский язык 10 лет.", BirthDate = DateTime.Parse("10.11.1993"), UserDates = new List<UserDate>(){ }, Email = "roman_karpov@mail.ru", Phone = "+79065456789", PhotoUrl = "/content/images/default-avatar.svg", Password = "1234567", Role="Tutor" },
        };
    }
}
